...
@Suppress("unused")
class CartScreenNode(buildContext: BuildContext, private val navigation: CartScreenNavigation) :
    Node(buildContext) {
    ...
    override fun View(modifier: Modifier) {
        ...
        CartScreen(modifier = modifier, state = state, useComponent = viewModel)
    }
}
