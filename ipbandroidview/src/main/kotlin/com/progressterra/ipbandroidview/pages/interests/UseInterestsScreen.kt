...
interface UseInterestsScreen : UseStateColumn, UseTopBar, UseButton {

    fun handle(event: InterestsScreenEvent)

    class Empty : UseInterestsScreen {

        override fun handle(event: InterestsScreenEvent) = Unit
