...
import com.progressterra.ipbandroidview.shared.IpbAndroidViewSettings.MAIN_CHAT_ID
...
interface FetchChatsUseCase : CacheUseCase<SupportChatState> {
    ...
    class Base(
        ...
        FetchChatsUseCase,
        AbstractCacheTokenUseCase<SupportChatState>(
            obtainAccessToken,
            makeToastUseCase,
            manageResources
        ) {
        ...
        override suspend fun invoke() {
            withCache { token ->
                ...
                SupportChatState(
                    ...
                    subCategories = flowOf(PagingData.from(listOf(main, wantThis, docs, orders)))
                )
            }
        }
    }
