...
/**
 * Abstract class for use cases that need to obtain an access token and cache their results. So
 * initial result is previous result (if any), and then if new result is different from previous, it
...
abstract class AbstractCacheTokenUseCase<T>(
    ...
    protected suspend fun withCache(block: suspend (accessToken: String) -> T) {
