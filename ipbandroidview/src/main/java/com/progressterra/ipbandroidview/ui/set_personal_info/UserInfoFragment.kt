...
import com.progressterra.ipbandroidview.databinding.FragmentSelfEmployedBinding
...
class UserInfoFragment : Fragment() {
    ...
    private lateinit var binding: FragmentSelfEmployedBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSelfEmployedBinding.inflate(inflater, container, false).apply {
            vm = viewModel
